...
template<typename Char>  struct initializer_tag<::ets::process::basic_environment<Char>>           { typedef env_tag<Char> type; };
template<typename Char>  struct initializer_tag<::ets::process::basic_native_environment<Char>> { typedef env_tag<Char> type; };
