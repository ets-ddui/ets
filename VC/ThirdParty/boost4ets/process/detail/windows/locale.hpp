...
class windows_file_codecvt
 ...
 protected:
   ...
   bool do_always_noconv() const BOOST_NOEXCEPT /*override*/ { return false; }

   //  seems safest to assume variable number of characters since we don't
   //  actually know what codepage is active
   int do_encoding() const BOOST_NOEXCEPT /*override*/ { return 0; }
   ...
   int do_max_length() const BOOST_NOEXCEPT /*override*/ { return 0; }
 };
