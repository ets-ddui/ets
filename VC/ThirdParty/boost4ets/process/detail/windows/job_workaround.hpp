...
namespace ets { namespace process { namespace detail { namespace windows { namespace workaround {
...
BOOST_CONSTEXPR_OR_CONST static ::boost::detail::winapi::DWORD_ JOB_OBJECT_LIMIT_BREAKAWAY_OK_ = 0x00000800;
