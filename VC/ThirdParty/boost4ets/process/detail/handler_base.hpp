...
{
    BOOST_CONSTEXPR make_handler_t() {}
    template<typename Handler>
    BOOST_CONSTEXPR_OR_CONST Template<Handler> operator()(Handler handler) const {return Template<Handler>(handler);}
    template<typename Handler>
    BOOST_CONSTEXPR_OR_CONST Template<Handler> operator= (Handler handler) const {return Template<Handler>(handler);}
    template<typename Handler>
    BOOST_CONSTEXPR_OR_CONST Template<Handler> operator+=(Handler handler) const {return Template<Handler>(handler);}
...
struct handler_base
{
    typedef void resource_type; //using resource_type = void;
