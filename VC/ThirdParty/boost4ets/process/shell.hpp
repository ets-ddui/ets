...
#include <process/detail/windows/shell_path.hpp>
#endif
...
struct shell_
{
    BOOST_CONSTEXPR shell_() {}

    boost::filesystem::path operator()() const
    {
        return ets::process::detail::api::shell_path();
    }
    boost::filesystem::path operator()(std::error_code & ec) const BOOST_NOEXCEPT
    {
        return ets::process::detail::api::shell_path(ec);
    }
};
...
*/
BOOST_CONSTEXPR ::ets::process::detail::shell_ shell;
