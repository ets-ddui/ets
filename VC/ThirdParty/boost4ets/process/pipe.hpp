...
using ::ets::process::detail::api::basic_pipe;
...
struct basic_pipebuf : std::basic_streambuf<CharT, Traits>
{
    ...
    BOOST_CONSTEXPR_OR_CONST static int default_buffer_size = BOOST_PROCESS_PIPE_SIZE;
...
public:
    ...
    ///Copy constructor.
private:basic_ipstream(const basic_ipstream & );public:// = delete;
    ///Move constructor.
...
public:
    ...
    ///Copy constructor.
private:basic_opstream(const basic_opstream & );public:// = delete;
    ///Move constructor.
...
public:
    ...
    ///Copy constructor.
private:basic_pstream(const basic_pstream & );public:// = delete;
    ///Move constructor.
    ...
    ///Copy assignment.
private:basic_pstream& operator=(const basic_pstream & );public:// = delete;
    ///Move assignment
