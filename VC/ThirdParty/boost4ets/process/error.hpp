...
struct throw_on_error_ : ::ets::process::detail::api::handler_base_ext
{
    BOOST_CONSTEXPR throw_on_error_() {};
...
struct ignore_error_ : ::ets::process::detail::api::handler_base_ext
{
    BOOST_CONSTEXPR ignore_error_() {};
};

struct set_on_error : ::ets::process::detail::api::handler_base_ext
{
...
BOOST_CONSTEXPR_OR_CONST ets::process::detail::ignore_error_ ignore_error;
...
BOOST_CONSTEXPR_OR_CONST ets::process::detail::throw_on_error_ throw_on_error;
/**
 ...
 */
BOOST_CONSTEXPR_OR_CONST ets::process::detail::error_ error;
///Alias for \xmlonly <globalname alt="boost::process::error">error</globalname> \endxmlonly .
BOOST_CONSTEXPR_OR_CONST ets::process::detail::error_ error_ref;
///Alias for \xmlonly <globalname alt="boost::process::error">error</globalname> \endxmlonly .
BOOST_CONSTEXPR_OR_CONST ets::process::detail::error_ error_code;
